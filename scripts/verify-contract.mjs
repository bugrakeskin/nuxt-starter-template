...
assert.equal(previewBuild.dns, '10.77.20.1')
...
assert.equal(previewScan.dns, '10.77.20.1')
...
assert.equal(deployStep.dns, '10.77.20.1')
...
assert.equal(mainBuild.dns, '10.77.20.1')
...
assert.equal(canaryBuild.dns, '10.77.20.1')
...
assert.deepEqual(canaryBuild.settings.build_args, { BUILD_REVISION: '${CI_COMMIT_SHA}' })
